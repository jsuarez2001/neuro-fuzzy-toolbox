...
class h_AntecedentBlock(nn.Module):
    ...
    """
    def __init__(self, input_size, num_mfs, normalization=True, rule_reduced=False, membership_function=GeneralizedBell_MF, dtype=torch.float32):
        ...
        if rule_reduced:
            ...
            self._rules = num_mfs**input_size
