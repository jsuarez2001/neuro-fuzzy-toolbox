from .func import GeneralizedBell_MF, Gaussian_MF, HighSlopeBell_MF, Linear_CF
...
from .training import SONFIS, alt_SONFIS, Hybrid_learning_algorithm, Basic_optimizer_training_algorithm, Double_optimizer_training_algorithm, EarlyStopping