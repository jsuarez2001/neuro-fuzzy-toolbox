...
class ConsequentLayer(nn.Module):
    ...
    def __init__(self, input_size, dtype, fuzzy_rules, consequent_function=Linear_CF, outputs=1, rule_reduced=False):
        ...
        if rule_reduced:
            init_consequents_rules = fuzzy_rules
        else:
            init_consequents_rules = fuzzy_rules**input_size
