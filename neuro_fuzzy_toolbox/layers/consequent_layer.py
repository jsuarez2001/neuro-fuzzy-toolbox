...
class rule_reduced_ConsequentLayer(nn.Module):
    
    def __init__(self, input_size, dtype, init_fuzzy_rules, consequent_function=Linear_CF, outputs=1):
        super(rule_reduced_ConsequentLayer, self).__init__()
        # Initialize consequent function
        self._consequent_function = consequent_function()
...
class complete_ConsequentLayer(nn.Module):
    
    def __init__(self, input_size, dtype, init_fuzzy_rules, consequent_function=Linear_CF, outputs=1):
        super(complete_ConsequentLayer, self).__init__()
        # Initialize consequent function
        self._consequent_function = consequent_function()
